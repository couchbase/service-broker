...
// EntryName defines a type for a name for type safety reasons.
...
func (r EntryName) name() (string, error) {
	if r.bindingID != "" {
...
func (r EntryName) annotations() map[string]string {
...
func ServiceInstanceRegistryName(instanceID string) EntryName {
	return EntryName{
...
// registry ConfigMap.
func ServiceBindingRegistryName(instanceID, bindingID string) EntryName {
	return EntryName{
		instanceID: instanceID,
		bindingID:  bindingID,
	}
...
// Entry is the main type used to lookup service instances and persist
// data.
type Entry struct {
...
func (r *Entry) GetOwnerReference() metav1.OwnerReference {
...
func (r *Entry) Get(key string) (string, error) {
...
func (r *Entry) Set(key, value string) error {
...
func (r *Registry) New(name EntryName) (*Entry, error) {
...
func (r *Registry) Get(name EntryName) (*Entry, error) {
	registryName, err := name.name()
	if err != nil {
		return nil, err
	}
...
func (r *Registry) Delete(name EntryName) error {
	registryName, err := name.name()
	if err != nil {
		return err
	}
