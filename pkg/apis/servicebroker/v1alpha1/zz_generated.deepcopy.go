...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in ConfigurationReadinessCheckList) DeepCopyInto(out *ConfigurationReadinessCheckList) {
	{
		in := &in
		*out = make(ConfigurationReadinessCheckList, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
		return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConfigurationReadinessCheckList.
func (in ConfigurationReadinessCheckList) DeepCopy() ConfigurationReadinessCheckList {
	if in == nil {
		return nil
	}
	out := new(ConfigurationReadinessCheckList)
	in.DeepCopyInto(out)
	return *out
}
